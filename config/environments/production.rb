...
ENV['FOG_DIRECTORY'] = 'coreymkimball'
ENV['AWS_ACCESS_KEY_ID'] = 'AKIAIMVOVDXIUOTMOSYQ'
ENV['AWS_SECRET_ACCESS_KEY'] = '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'
Hadean::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'jai-test-app.herokuapp.com' }
